...
#
# Generated by export_simulation on Sat Nov 08 21:15:41 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './ARM_TOP_tb.sh' script.

./ARM_TOP_tb.sh -reset_run
...
./ARM_TOP_tb.sh -noclean_files

For more information on the script, please type './ARM_TOP_tb.sh -help'.
