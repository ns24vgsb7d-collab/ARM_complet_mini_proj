...
#
# Generated by Vivado on Sat Nov 08 21:15:41 -0500 2025
# SW Build 3671981 on Fri Oct 14 05:00:03 MDT 2022
#
# Tool Version Limit: 2022.10 
#
# usage: ARM_TOP_tb.sh [-help]
# usage: ARM_TOP_tb.sh [-lib_map_path]
# usage: ARM_TOP_tb.sh [-noclean_files]
# usage: ARM_TOP_tb.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "ARM_TOP_tb.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L secureip -L xpm --snapshot ARM_TOP_tb xil_defaultlib.ARM_TOP_tb -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  ARM_TOP_tb -key {Behavioral:sim_1:Functional:ARM_TOP_tb} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./ARM_TOP_tb.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ARM_TOP_tb.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./ARM_TOP_tb.sh -help\" for more information)\n"
    exit 1
  fi
